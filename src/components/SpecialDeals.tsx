  ...
  return (
    <section className="py-16 bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-800 dark:text-gray-200">Special Deals</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {deals.map((deal) => (
            <div key={deal.name} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              <Image
                src={deal.image}
                alt={deal.name}
                width={300}
              ...
              />
              <div className="p-4">
                <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-gray-200">{deal.name}</h3>
                <p className="text-blue-600 dark:text-blue-400 font-bold mb-4">{deal.discount}</p>
